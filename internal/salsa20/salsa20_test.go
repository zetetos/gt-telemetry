...
func (suite *Salsa20TestSuite) TestEmptySalsa20ContentReturnsNilWithError() {
	...
	// Act
	gotValue, err := salsa20.Decode(ivSeed, encodedValue)
...
func (suite *Salsa20TestSuite) TestValidSalsa20ContentReturnsDecodedData() {
	// Arrange
	wantValue := magicPacketHeader()

	// Act
	gotValue, err := salsa20.Decode(ivSeed, validSalsa20Content())
	suite.Require().NoError(err)

	// Assert
	suite.Equal(wantValue, gotValue[0:4])
}
